...
var TapoDevice = function (_a) {
    var send = _a.send;
    var setDeviceOn = function (deviceOn) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, send(turnDeviceOnRequest)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return {
        turnOn: function () { return setDeviceOn(true); },
        turnOff: function () { return setDeviceOn(false); },
